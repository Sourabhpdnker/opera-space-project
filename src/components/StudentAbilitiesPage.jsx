...
//data for professors
const bloodGroups = [
  { bloodgrp: "A+", massage: "You are a fast learning student" },
  { bloodgrp: "B+", massage: "You have a positive attitude" },
  { bloodgrp: "AB+", massage: "You have great creativity" },
  { bloodgrp: "O+", massage: "You are highly adaptable" },
  { bloodgrp: "A-", massage: "You excel in time management" },
  { bloodgrp: "B-", massage: "You have excellent adaptability" },
  { bloodgrp: "AB-", massage: "You are a great team player" },
  { bloodgrp: "O-", massage: "You are a quick problem solver" },
];
  ...
  return (
    <>
      <div className=" bg-[url('./assets/images/bgimg.jpg')] bg-center bg-cover flex-col justify-center px-1 flex h-screen w-screen flex-1 py-12 lg:px-8 bg-gray-100">
        ...
        <div className="bg-sky-900 font-bold text-start max-w-auto h-auto w-auto sm:my-3 my-15 mx-10 p-5 py-10 rounded-lg shadow-md">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-4 lg:mx-10">
            {bloodGroups.map(
              (
                ...
                <button
                  key={group.bloodgrp}
                  className="bg-cyan-500 text-black font-ibold px-auto py-4 text-center rounded-md  shadow-mdbg-blue-500 hover:bg-blue-700 font-bold px-4 focus:outline-none focus:ring focus:ring-blue-300 transition-transform transform-gpu hover:scale-105 shadow-md shadow-black"
